...
function App() {
  ...
  return (
    <div className="text-center">
      <header className="bg-amber-500 max-h-fit px-2.5 py-2.5 relative">
        <nav className="flex items-center justify-between">
          <img src={logo} className="w-64 h-20" alt="logo" />
          <ul className="px-4 m-0">
            <li className="inline-block mx-0 my-5 ">
              <a className="text-slate-900 font-bold px-3.5" href="./pages/howToPlay.tsx">How To Play</a>
            </li>
            <li className="inline-block mx-0 my-5 ">
              <a className="text-slate-900 font-bold px-3.5" href="./pages/about.tsx">About</a>
            </li>
            <li className="inline-block mx-0 my-5 ">
              <ConnectWallet />
            </li>
      ...
      <main className="flex items-center justify-evenly min-h-[80vh]">
        <div>
          <h1 className="text-slate-900 mx-1.5 my-12 text-6xl font-bold">Welcome to Joker Poker!</h1>
      ...
      <footer className="text-slate-900 flex flex-col items-center justify-center font-bold max-h-[20vh] text-2xl">
